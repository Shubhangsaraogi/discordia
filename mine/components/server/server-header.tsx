    ...
    return (
        <div>
            <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 font-medium text-xs text-black dark:text-neutral-400 space-y-[2px]">
                    {isModerator &&(
                        <DropdownMenuItem 
                    ...
                    {isModerator && (
                     ...
                     {isAdmin && (
                        ...
                        onClick={()=>onOpen("deleteServer",{server})}
                         className="text-rose-500 px-3 text-sm cursor-pointer">
                            Delete Server 
